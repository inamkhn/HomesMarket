...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const fetchRentListings = async () => {
      try {
        const res = await axios.get(`http://localhost:5000/api/v1/get/sas?type=rent&limit=4`);
    ...
    const fetchSaleListings = async () => {
      try {
        const res = await axios.get(`http://localhost:5000/api/v1/get/sas?type=sale&limit=4`);
